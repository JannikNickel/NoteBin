...
namespace NoteBin.Models.API
{
	public record ErrorResponse(string Error)
	{
		...
		public static ObjectResult InvalidUsername => WithStatus(StatusCodes.Status400BadRequest, $"Invalid username! (length <= {UserHelper.NameLengthLimit}, allowed characters: a-z, A-Z, 0-9, _)");
		public static ObjectResult InvalidPassword => WithStatus(StatusCodes.Status400BadRequest, $"Invalid password! (length >= {UserHelper.MinPasswordLength}, must contain lowercase letter, uppercase letter and digit");
